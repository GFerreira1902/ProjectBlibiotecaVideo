...
const JogosVideo = () => {
    ...
    const handleJogos = () => setShowLan(false);
    ...
    useEffect(() => {
        setVideos (JogosService.get(params.id))
        setJogos(JogosService.getAll())
        if (params.id) {
            const video = JogosService.get(params.id)
    ...
    return (
        <div className="mt-5" style={{color:'black'}} >
            ...
            <Row>
                ...
                <Col md={5} >
                    {jogos.map((jogos, i) => (
                        ...
                        <a href={"/jogos/"+i} >
                            <Card style={{ backgroundColor: '#000000', width: '350px', height: '245px', margin: '10px', color: 'white', textAlign: 'center', borderRadius: '35px', justifyContent: 'center' }} border='primary' key={jogos.id} href="#">
                                <Card.Img variant='top' src={jogos.thumb} style={{ width: '100%', height: '70%', borderRadius: '35px' }} />
                                <Card.Body>
                                    <Card.Title style={{ fontSize: '15px', }} >{jogos.nome}</Card.Title>                                                               
                                </Card.Body>
                            </Card>
                        </a>
            ...
            <Modal show={showlan} onHide={handleJogos} >
