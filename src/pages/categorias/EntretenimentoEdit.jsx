...
const EntretenimentoEdit = () => {
  ...
  function salvarentretenimento(dados) {
    if (params.id) {
    ...
    navigate('/categoria/entretenimento')  
  }
  ...
  return (
      <div align='center' style={{color:'black'}}>
        <Col md={8} className='mt-3'>
          ...
          <Button variant="primary" onClick={handleSubmit(salvarentretenimento)}>
              Alterar
          </Button>
        </Col>
      </div>     
...
export default EntretenimentoEdit